...
def main():
    ...
    pesanDekripsi= "PAPKCZPQLRGCCQWEXMNQQMPJKUWUVMNXJLOCKUOZCDDAIEIJSIPUDCKFRQVSNXPUYKSU"
    kunci = 'INEZLSYA'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'PAPKCZPQLRGCCQWEXMNQQMPJKUWUVMNXJLOCKUOZCDDAIEIJSIPUDCKFRQVSNXPUYKSU'#Pesan yang akan di enkripsi
    key = [3, 5]
    ...
    print('Encrypted Text: HNLLRHHDHSVKUDSFMUFDMNERDHSVKUFKFMDKDHKARLVNEFXRKVLVSKDSNRKAFHLVNSKH'.format( affine_encrypted_text ))
    print("")
 
    # memanggil fungsi dekripsi
    print('Ciphertext : HNLLRHHDHSVKUDSFMUFDMNERDHSVKUFKFMDKDHKARLVNEFXRKVLVSKDSNRKAFHLVNSKH')
    print('Decrypted Text: PAPKCZPQLRGCCQWEXMNQQMPJKUWUVMNXJLOCKUOZCDDAIEIJSIPUDCKFRQVSNXPUYKSU'.format
